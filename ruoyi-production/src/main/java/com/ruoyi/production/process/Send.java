...
public class Send {
    ...
    public static List<EmpLog> work(com.ruoyi.production.resource.facilities.buffer.Tally tally, List<com.ruoyi.production.resource.equipment.Tray> trays, double sortingSpeed, List<com.ruoyi.production.resource.personnel.Emp> emps, double batch, String sort_type, int orderLine, double sortingTime) {
