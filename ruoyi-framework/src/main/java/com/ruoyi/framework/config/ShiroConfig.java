...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        // 对静态资源设置匿名访问
        filterChainDefinitionMap.put("/lkZDjhVU4m.txt", "anon");
...
//        filterChainDefinitionMap.put("/img/point/**", "anon");
        ...
        filterChainDefinitionMap.put("/system/point/point/network3", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/point/point/network4", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/point/point/network5", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/wxorder/addOrder", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/point/index", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/point/bigdata", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/point/survey", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/point/index2", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/point/index3", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/point/index4", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/point/downloadFile", "anon,captchaValidate");
        filterChainDefinitionMap.put("/system/point/uploadFile", "anon,captchaValidate");
        ...
        filterChainDefinitionMap.put("/common/download", "anon,captchaValidate");
        ...
        filterChainDefinitionMap.put("/getQRCodeUrl", "anon,captchaValidate");
        filterChainDefinitionMap.put("/downLoad", "anon,captchaValidate");
        // 注册相关
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/file/**").addResourceLocations("file:C:/var/uploaded_files/");
    }
    /**
     * 自定义在线用户处理过滤器
     */
