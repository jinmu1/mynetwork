...
public class NetWorkTest {
    ...
    @Autowired
    private IGlcPointService pointService;
    ...
    public void getNodesNum(){
        ...
        List<GlcPoint> list = pointService.selectGlcPointList(new GlcPoint(provinces));
        double tansportCost  = NetworkUtils.getNetWorkData(carType,transportNum,list);
